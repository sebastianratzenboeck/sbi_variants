#!/bin/bash
#SBATCH -J sbi-FM-attnpool
#SBATCH -p gpu
#SBATCH -t 2-00:00
#SBATCH --mem=350000
#SBATCH -c 16
#SBATCH --gres=gpu:nvidia_a100-sxm4-80gb:1
#SBATCH -o fm_attnpool_%j.out
#SBATCH -e fm_attnpool_%j.err
...
OUTPUT_DIR="/n/holystore01/LABS/itc_lab/Lab/to-Sebastian/fm_sbi_colors_attnpool"
...
RUN_NAME="fm_attnpool_colors_tau-0_beta-025_epochSize5M_maxEpochs300"
